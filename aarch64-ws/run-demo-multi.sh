...
make -C CROSSCON-Hypervisor/ \
	...
	CONFIG=qemu-virt-aarch64-multi \
	OPTIMIZATIONS=0 \
        SDEES="sdSGX sdTZ" \
...
cp -uv CROSSCON-Hypervisor/bin/qemu-aarch64-virt/builtin-configs/qemu-virt-aarch64-multi/crossconhyp.bin ./aarch64-ws/bl33.bin
